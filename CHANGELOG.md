...
- **Atomic burn-on-read.** A single conditional DynamoDB `DeleteItem` guarantees exactly one reader per note, with no race window. Expired notes are never served.
