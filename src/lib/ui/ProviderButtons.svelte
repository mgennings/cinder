<script lang="ts">
	...
	//
	// It holds no copy of its own beyond the two labels, which are the labels
	// Apple and Google require, and it makes no decision about what happens
	// after — it hands the provider back and the page decides. That is the seam:
	// everything Cinder-specific about signing in lives in the page, and
	// everything brand-specific about the buttons lives here.
	//
